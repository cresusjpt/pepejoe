package com.saltechdigital.pizzeria.contentProvider;
...
public class PlacesSuggestionProvider extends ContentProvider {
    ...
    private static final String LOG_TAG = Config.TAG;
    ...
    @Override
    public int delete(@NotNull Uri uri, String arg1, String[] arg2) {
    ...
    @Override
    public Uri insert(@NotNull Uri uri, ContentValues arg1) {
        throw new UnsupportedOperationException();
    }
    ...
    @Override
    public int update(@NotNull Uri uri, ContentValues arg1, String arg2, String[] arg3) {
        throw new UnsupportedOperationException();
    }
}
